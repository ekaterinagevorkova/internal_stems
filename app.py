...
st.set_page_config(page_title="PNG → WebP или HTML", layout="centered")
...
- **HTML** — каждый PNG встраивается внутрь HTML-файла (base64), удобно для передачи или встраивания
""")

st.divider()

# Выбор формата
format_choice = st.radio("Формат конвертации", ["WebP", "HTML"], horizontal=True)
